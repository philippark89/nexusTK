donor_scroll = {
	use = function(player)
		...
		if scrollName == "Donor Scroll 1" then
			...
			broadcast(
				-1,
				"[NexusTK Team] A huge thank you to " .. player.name .. " for their donation!"
			)
			player:addLegend(
		...
		if scrollName == "Donor Scroll 2" then
			...
			broadcast(
				-1,
				"[NexusTK Team] A huge thank you to " .. player.name .. " for their great donation!"
			)
			player:addLegend(
		...
		if scrollName == "Donor Scroll 3" then
			...
			broadcast(
				-1,
				"[NexusTK Team] A huge thank you to " .. player.name .. " for their amazing donation!"
			)
			player:addLegend(
		...
		if scrollName == "Donor Scroll 4" then
			...
			broadcast(
				-1,
				"[NexusTK Team] A huge thank you to " .. player.name .. " for their fantastic donation!"
			)
			player:addLegend(
		...
		if scrollName == "Donor Scroll 5" then
			...
			broadcast(
				-1,
				"[NexusTK Team] A huge thank you to " .. player.name .. " for their astounding donation!"
			)
			player:addLegend(
