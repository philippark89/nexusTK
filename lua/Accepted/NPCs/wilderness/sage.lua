SageNpc = {
	click = async(function(player, npc)
		...
		"Sharing of wisdom not needed to the world of NexusTK can result in loss of this spell.",
		...
		"Breaking any other law in NexusTK using this spell will result in loss of the spell."},1)]]
		--
		...
		player:dialogSeq(
			{
				...
				"Jailing for ANY crime will result in loss of this spell.",
				"Breaking any other law in NexusTK using this spell will result in loss of the spell."
			},
			1
		)
