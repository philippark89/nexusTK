	...
	click = async(function(player, npc)
		...
		elseif choice == "My character webpage" then
			local choice = player:menuString(
				"What do you want to do with your NexusTK user webpage?",
				{"Change", "Remove", "Help"}
			)
			...
			elseif choice == "Help" then
				player:dialogSeq(
					{
						t,
						"This feature will allow you to set up your own specific options for a NexusTK user page (https://users.nexustk.com)",
