		...
		player:dialogSeq(
			{
				...
				"Be conscientious. Do not harass or steal from other players. Report bugs, and do not exploit them. Do not share your password with anyone, including NexusTK staff."
			}, 1)
