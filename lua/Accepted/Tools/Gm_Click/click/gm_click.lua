gm_click = {
	...
	bug_legend = function(player, gm)
		...
		if reg > 0 then
			...
			player:addLegend(
				"Recognized for finding " .. player.registry["bugs_found"] .. " bugs in NexusTK",
				"bugfinder",
				213,
				244
			)
			...
			player:addLegend(
				"Recognized for finding 1 bug in NexusTK",
				"bugfinder",
				213,
				244
			)
	...
	gmassist_legend = function(player, gm)
		...
		if reg > 0 then
			...
			player:addLegend(
				"Assisted the NexusTK GMs " .. player.registry["gm_assist"] .. " times",
				"gmassist",
				145,
				226
			)
			...
			player:addLegend(
				"Assisted the NexusTK GMs 1 time",
				"gmassist",
				145,
				226
			)
