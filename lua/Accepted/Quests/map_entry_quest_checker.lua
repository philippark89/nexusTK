map_entry_quest_checker = async(function(player)
	...
	if mapName == "Welcome" then
		...
		player:dialogSeq(
			{
				t,
				"Hello and welcome to NexusTK. Please journey south to begin your tutorial quest and get a weapon, armor, and your first spell."
			},
			1
		)
			...
			player:dialogSeq(
				{
					...
					"Using this system and the Mini Map (Press 'm'), you can find your way around the cities and towns of NexusTK. You can also find the important places by pressing the 'F1' key"
				},
				1
			)
		end
