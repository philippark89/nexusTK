...
int clif_sendprofile(USER* sd)
{
	...
	char url[255];
	sprintf(url, "https://www.nexustk.com/users");
...
int clif_sendboard(USER* sd) {
	...
	char url1[] = "https://www.nexustk.com/boards"; // this first URL doesnt appear to do shit.. might be like a referral
	char url2[] = "https://www.nexustk.com/boards"; // This is the actual URL that the browser goes to
...
printf("\n");*/
	...
	case 0x27: // PACKET SENT WHEN SOMEONE CLICKS QUEST tab or SHIFT Z key
		...
		//clif_sendurl(sd,0,"https://www.nexustk.com/questguide/");
